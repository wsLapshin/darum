...
<div class="form-group">
    <label><?php echo 'Генерация ссылок' ?></label>
    <div class="checkbox">
        <label>
            <?php echo $form->checkbox('akSelectGenerateSlug', 1, $akSelectGenerateSlug)?> <span>
            <?php echo 'Генерировать ссылки для пометок статей в категории'?></span>
        </label>
    </div>
</div>
