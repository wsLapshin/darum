 ...
 */
class SelectSettingsDarum extends Settings
{
    /** @todo унаследоваться от Concrete\Core ... SelectSettings сейчас не работает
    /**
     * @ORM\Column(type="boolean")
     */
    protected $akSelectGenerateSlug = false;
   
    /**
     * @return mixed
     */
    public function getGenerateSlug()
    {
        return $this->akSelectGenerateSlug;
    }

    public function setGenerateSlug($value)
    {
        $this->akSelectGenerateSlug = $value;
    }
