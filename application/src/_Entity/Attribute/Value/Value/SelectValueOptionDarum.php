...
//use Concrete\Core\Entity\Attribute\Value\Value\SelectValueOption as SelectValueOptionCore;
...
class SelectValueOptionDarum 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Concrete\Core\Entity\Attribute\Value\Value\SelectValueOptionList", inversedBy="options")
     * @ORM\JoinColumn(name="avSelectOptionListID", referencedColumnName="avSelectOptionListID")
     */
    protected $list;

    /**
     * @ORM\ManyToMany(targetEntity="\Concrete\Core\Entity\Attribute\Value\Value\SelectValue", mappedBy="selectedOptions", cascade={"remove"})
     */
    protected $values;
