...
class ParentsAdvices extends AbstractContainer
{
    ...
    {
       $this->categoryCID = DarumPageUtils::ADVICE_PARENTS_CATEGORY_CID;
       $this->neighbourCategoryCID = DarumPageUtils::ARTICLE_PARENTS_CATEGORY_CID;
