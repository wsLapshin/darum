        ...
        <div class="page__viewport">
            ...
            <div class="l-container page__container">
                ...
                <?php if ($slug== DarumPageUtils::NEW_SLUG):?>
                    <span class="page__header"><h1 class="allarticles-h1">Новые статьи <?=$whom?></h1></span>
                <?php elseif($slug== DarumPageUtils::POPULAR_SLUG):?>
                    <span class="page__header"><h1 class="allarticles-h1">Популярные статьи <?=$whom?></h1></span>
                <?php elseif($slug):?>
